...
| HARDEN-P2-03 | Vendor upgrades | Schedule quarterly Tencent VOD, Zoom, Next.js, Prisma, Shaka, and Vercel review. | Vendor SDKs and hosting behavior change over time. | Upgrade review issue created each quarter. |
