...
This document satisfies OPS-02. It defines repeatable upgrade playbooks for Tencent VOD Commercial DRM, Zoom, Next.js, Prisma, Shaka Player, and Vercel/deployment dependencies.
...
- https://cloud.tencent.com/document/api/266/32586
...
5. Run tests for media entitlement, data bounds, admin analytics, watermark settings, and Tencent sync.
...
2. Reconfirm `NEXTAUTH_URL`, OAuth callbacks, Tencent webhook URLs, Zoom allowed domains, Tencent playback domain, and public player origins.
